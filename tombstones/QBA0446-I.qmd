...
place: |
    ...
    Азербайджан
name-ru: |
    АГАГАБАЕВА Йохевед, дочь Гершома (Хивит Гуршумовна)
...
[Куба (центральное)](../cemeteries/QBA.html) > QBA0446
:::
...
knitr::include_graphics("../images/QBA0446_0.JPG")
knitr::include_graphics("../images/QBA0446_1.JPG")
...
```{r}
tibble(`Оригинал` = "פ׳נ׳
ה׳ה יוכבד בת גרשום יום
שבת ק׳ ד׳ חודש חשון שנת
התשכ׳ט לב׳ע
АГАБАБАЕВА ХИВИТ
ГУРШУМОВНА
Р. 1877 - У. 19 26/X 68",
       `Перевод` = "Здесь погребена
покойная госпожа Йохевед, дочь Гершома. День
святой субботы, 4-го хешвана, год
...
|**Координаты**      |[41.37103173, 48.5076038](https://www.google.com/maps/place/41.37103173, 48.5076038)                    |
: {tbl-colwidths="[25,75]"}
