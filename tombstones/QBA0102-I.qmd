...
knitr::include_graphics("../images/QBA0102_0.JPG")
knitr::include_graphics("../images/QBA0102_1.JPG")
knitr::include_graphics("../images/QBA0102_2.JPG")
knitr::include_graphics("../images/QBA0102_3.JPG")
...
|**Элементы декора** |стела: портрет, звезды Давида на лицевой стороне, по бокам, минора на обратной стороне, плита: две розы, за памятником - две подсвечника                                                                          |
