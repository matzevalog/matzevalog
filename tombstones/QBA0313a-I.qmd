...
[Куба (центральное)](../cemeteries/QBA.html) > QBA0313a
:::
...
knitr::include_graphics("../images/QBA0313a.JPG")
...
|-|---|
|**Тип памятника**   |стела                                                                         |
|**Материал**        |природный камень (сколы, следы эрозии)                                                     |
|**Размеры**         |33×22×9                                                                        |
|**Тип декора**      |-                                                                        |
|**Элементы декора** |                                                                           |
|**Координаты**      |[41.37073512, 48.50719631](https://www.google.com/maps/place/41.37073512, 48.50719631)                    |
: {tbl-colwidths="[25,75]"}
