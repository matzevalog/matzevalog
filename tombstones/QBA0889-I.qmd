...
[Куба (центральное)](../cemeteries/QBA.html) > QBA0889
:::
...
knitr::include_graphics("../images/QBA0889.JPG")
...
|**Материал**        |металл (следы эрозии, ржавчина)                                                     |
|**Размеры**         |134×35×3                                                                        |
|**Тип декора**      |традиционная символика                                                                        |
|**Элементы декора** |столб венчает звезда Давида                                                                          |
|**Координаты**      |[41.37125598, 48.50909085](https://www.google.com/maps/place/41.37125598, 48.50909085)                    |
: {tbl-colwidths="[25,75]"}
