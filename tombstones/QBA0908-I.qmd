...
[Куба (центральное)](../cemeteries/QBA.html) > QBA0908
:::
...
knitr::include_graphics("../images/QBA0908_0.JPG")
knitr::include_graphics("../images/QBA0908_1.JPG")
...
```{r}
tibble(`Оригинал` = "יונה בנ אבשלום
אבש לוםוב
כ״ד שבט השל״ג
Юна Бэн Авшолом
1973
от дочки",
       `Перевод` = "Йона, сын Авшалома,
Авшаломов.
24 швата 5733 года.
Юна, сын Авшолома.
1973
...
|**Размеры**         |38×66×26  --- стела; 12×58×136  --- плита; 18×80×175  --- основание                                                                        |
|**Тип декора**      |традиционная символика                                                                        |
|**Элементы декора** |звезда Давида на табличке                                                                          |
|**Координаты**      |[41.37127675, 48.50916318](https://www.google.com/maps/place/41.37127675, 48.50916318)                    |
: {tbl-colwidths="[25,75]"}
