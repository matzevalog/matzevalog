...
place: |
    ...
    Азербайджан
name-ru: |
    ЯКУБОВА Мурвори, дочь Нафтали (Мирвори Нафталиевна)
...
[Куба (центральное)](../cemeteries/QBA.html) > QBA0471
:::
...
knitr::include_graphics("../images/QBA0471_0.JPG")
knitr::include_graphics("../images/QBA0471_1.JPG")
...
Мирвори, дочь Нафтали, 
[скончавшаяся] двадцать первого тишрея 5702 года
Якубова Мирвори
Нафталиевна
1893 - 03.10.1942
Память от сына") |>
...
|**Размеры**         |52×55×35  --- стела; 17×52×117  --- плита; 32×75×175  --- основание                                                                        |
|**Тип декора**      |традиционная символика                                                                        |
|**Элементы декора** |звезда Давида на текстовой вставке, медальон с портретом                                                                          |
|**Координаты**      |[41.37081538, 48.50777598](https://www.google.com/maps/place/41.37081538, 48.50777598)                    |
: {tbl-colwidths="[25,75]"}
