...
[Куба (центральное)](../cemeteries/QBA.html) > QBA0975a
:::
...
knitr::include_graphics("../images/QBA0975a.JPG")
...
|-|---|
|**Тип памятника**   |стела                                                                         |
|**Материал**        |природный камень (скол)                                                     |
|**Размеры**         |36×21×12                                                                        |
|**Тип декора**      |-                                                                        |
|**Элементы декора** |                                                                           |
|**Координаты**      |[41.37108537, 48.50974174](https://www.google.com/maps/place/41.37108537, 48.50974174)                    |
: {tbl-colwidths="[25,75]"}
