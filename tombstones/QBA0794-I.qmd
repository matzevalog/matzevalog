...
place: |
    ...
    Азербайджан
name-ru: |
    САСУНОВ Элазар Цион, сын Яакова (Илиизир)
...
[Куба (центральное)](../cemeteries/QBA.html) > QBA0794
:::
...
knitr::include_graphics("../images/QBA0794_1.JPG")
knitr::include_graphics("../images/QBA0794_2.JPG")
...
|**Размеры**         |213×58×38  --- стела; 21×52×120  --- плита; 42×79×193  --- основание                                                                        |
|**Тип декора**      |архитектурно-орнаментальный, растительный, традиционная символика                                                                        |
|**Элементы декора** |навершие в форме бутона, портал с полуколоннами, звезда Давида и фотопортрет на вставке                                                                          |
|**Координаты**      |[41.37123139, 48.5088626](https://www.google.com/maps/place/41.37123139, 48.5088626)                    |
: {tbl-colwidths="[25,75]"}
