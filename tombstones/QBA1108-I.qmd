...
[Куба (центральное)](../cemeteries/QBA.html) > QBA1108
:::
...
knitr::include_graphics("../images/QBA1108_1.JPG")
knitr::include_graphics("../images/QBA1108_2.JPG")
...
Элиэзер, душа его в раю, сын
рабби Эфраима,
благословенна память праведника, <ушел> в вечность
в 1 день 
месяца таммуз,
года я 
сплю, но сердце мое 
бодрствует* (581), и так далее,
...
|**Координаты**      |[41.36950028, 48.50799986](https://www.google.com/maps/place/41.36950028, 48.50799986)                    |
: {tbl-colwidths="[25,75]"}
