...
[Куба (центральное)](../cemeteries/QBA.html) > QBA1138
:::
...
knitr::include_graphics("../images/QBA1138.JPG")
...
Песах, сын р. Исраэля.
Воскресенье,
7 число месяца таммуз
года 607 по малому летоисчислению.") |>
...
|**Размеры**         |98×41×23  --- стела                                                                        |
|**Тип декора**      |архитектурно-орнаментальный                                                                        |
|**Элементы декора** |ниша для текста                                                                          |
|**Координаты**      |[41.36947522, 48.50692323](https://www.google.com/maps/place/41.36947522, 48.50692323)                    |
: {tbl-colwidths="[25,75]"}
