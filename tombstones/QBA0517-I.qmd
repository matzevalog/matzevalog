...
place: |
    ...
    Азербайджан
name-ru: |
    ИСАКОВ Нисан, сын Рахамима (Рахамимович)
...
[Куба (центральное)](../cemeteries/QBA.html) > QBA0517
:::
...
knitr::include_graphics("../images/QBA0517_1.JPG")
knitr::include_graphics("../images/QBA0517_4.JPG")
...
|**Элементы декора** |фотопортрет мужчины; звезда Давида над текстом эпитафии                                                                          |
|**Координаты**      |[41.37111541, 48.50779783](https://www.google.com/maps/place/41.37111541, 48.50779783)                    |
: {tbl-colwidths="[25,75]"}
