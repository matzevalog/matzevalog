...
[Куба (центральное)](../cemeteries/QBA.html) > QBA1049
:::
...
knitr::include_graphics("../images/QBA1049_1.JPG")
knitr::include_graphics("../images/QBA1049_2.JPG")
...
и милости, щедрый
Захарья, сын р. Йосефа.
Да будет душа его завязана в узле жизни. И скончался
...
|**Размеры**         |126×20×37  --- стела                                                                        |
|**Тип декора**      |архитектурно-орнаментальный                                                                        |
|**Элементы декора** |фигурная ниша для текста                                                                          |
|**Координаты**      |[41.37058625, 48.50877737](https://www.google.com/maps/place/41.37058625, 48.50877737)                    |
: {tbl-colwidths="[25,75]"}
