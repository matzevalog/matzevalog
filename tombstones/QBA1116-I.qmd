...
[Куба (центральное)](../cemeteries/QBA.html) > QBA1116
:::
...
knitr::include_graphics("../images/QBA1116_1.JPG")
knitr::include_graphics("../images/QBA1116_2.JPG")
...
תריד לפ֗ק֗",
       `Перевод` = "Здесь 
покоится человек щедрый
на подаяние, который
любил Тору
и изучение ее, уважаемо
имя его, Палтиэль, сын р.
Узияху, который скончался 15
ава, в среду, года
...
|**Координаты**      |[41.36986007, 48.50720652](https://www.google.com/maps/place/41.36986007, 48.50720652)                    |
: {tbl-colwidths="[25,75]"}
