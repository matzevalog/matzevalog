...
[Куба (центральное)](../cemeteries/QBA.html) > QBA0364
:::
...
knitr::include_graphics("../images/QBA0364.JPG")
...
|**Материал**        |металл (ржавчина, следы краски, звезда окрашена в серебряный)                                                     |
|**Размеры**         |150×47×6  --- Общее                                                                        |
|**Тип декора**      |традиционная символика                                                                        |
|**Элементы декора** |звезда Давида                                                                          |
|**Координаты**      |[41.37104444, 48.50736668](https://www.google.com/maps/place/41.37104444, 48.50736668)                    |
: {tbl-colwidths="[25,75]"}
