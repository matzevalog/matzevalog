...
[Куба (центральное)](../cemeteries/QBA.html) > QBA0619
:::
...
knitr::include_graphics("../images/QBA0619_1.JPG")
knitr::include_graphics("../images/QBA0619_2.JPG")
...
|**Материал**        |известняк (следы эрозии, сколы, цементный раствор)                                                     |
|**Размеры**         |165×140×229                                                                        |
|**Тип декора**      |архитектурно-орнаментальный                                                                        |
|**Элементы декора** |округлое завершение                                                                          |
|**Координаты**      |[41.37104508, 48.50816937](https://www.google.com/maps/place/41.37104508, 48.50816937)                    |
: {tbl-colwidths="[25,75]"}
